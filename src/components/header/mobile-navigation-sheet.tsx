                  ...
                  {navigationItems.map((item, index) => (
                    ...
                    >
                      <motion.a
                        ...
                        className={`block text-3xl md:text-4xl font-bold transition-colors duration-300 py-6 px-8 rounded-2xl cursor-pointer ${activeSection === item.href
                          ? 'text-primary'
                      ...
                      >
                        ...
                        >
                          {item.title}
                          <motion.div
                            className={`absolute inset-0 rounded-2xl transition-all duration-300 ${activeSection === item.href
